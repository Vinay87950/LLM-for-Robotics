"""
A script to collect a batch of human demonstrations. exactly copied from robosuite 
'https://github.com/ARISE-Initiative/robosuite/blob/cb173eb465089b1b4d7038dc8e913f18817f2b0f/robosuite/scripts/collect_human_demonstrations.py#L4'

The demonstrations can be played back using the `playback_demonstrations_from_hdf5.py ` script.


or use this script use 'python collect_human_demonstrations.py --environment Lift --device keyboard --num_samples 5'
...
def gather_demonstrations_as_hdf5(directory, out_dir, env_info):
    ...
    Returns:
        int: Number of successful demonstrations saved
    """
...
if __name__ == "__main__":
    ...
    # MODIFIED: Create data_collected directory in the same folder as the script
    script_dir = os.path.dirname(os.path.abspath(__file__))
    data_collected_dir = os.path.join(script_dir, "data_collected")
    
    # Create data_collected directory if it doesn't exist
    ...
    print(f"Data will be collected in: {tmp_directory}")
    ...
    # MODIFIED: make a new timestamped directory inside data_collected
    t1, t2 = str(time.time()).split(".")
    new_dir = os.path.join(data_collected_dir, "{}_{}".format(t1, t2))
    os.makedirs(new_dir)
    
    print(f"HDF5 file will be saved in: {new_dir}")

    # collect demonstrations
    successful_demos = 0
    print(f"\nStarting data collection. Target: {args.num_samples} successful demonstrations")
    print(f"Progress: {successful_demos}/{args.num_samples}\n")
